...
| ARLOCAL-007 | 4 Ariadne | Adaptar skill a Backlog MCP y CLI | hecho | ARLOCAL-003 | Ariadne usa operaciones Backlog cuando existen y cae a Markdown solo cuando corresponde | `/Users/mauriciootalvaro/.codex/skills/ariadne/SKILL.md` actualizado | Usar contrato en próximos planes |
...
- 2026-07-28: Se establece protocolo operativo permanente: toda corrección debe comenzar leyendo este ledger, el JM correspondiente y su historial/evidencia; después se documentan causa raíz, dependencia, pruebas, despliegue y riesgo residual. No se marcará `Done` sin evidencia verificable.
