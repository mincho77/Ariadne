...
test('inferBugTheme groups bugs by dominant area', () => {
  assert.equal(inferBugTheme({ title: 'BUG producción · Agente no procesa archivos', labels: ['bug'] }), 'IA y automatización');
...
test('bugs board renders analytics and filtered kanban', () => {
  ...
  assert.match(html, /Plantilla AC/);
